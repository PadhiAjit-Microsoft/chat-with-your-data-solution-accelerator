...
* [ ] Step 6.6: Delete the leftover old `<OLD_SUFFIX>` resource set (user-consented, destructive; old-suffix only) — executes LAST, after 6.4/6.5/6.7 are deployed green
